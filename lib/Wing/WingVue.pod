...
A toggle switch component.
 ...
 <toggle v-model="edit_mode" label="Edit Mode"></toggle>

=over

=item v-model

The field to toggle back and forth. 
...
Add a DOM id to the control.

=item classWrap

A CSS class to wrap the whole control in.

=item sync

A boolean indicating whether to debounce the value changing from outside the toggle.
