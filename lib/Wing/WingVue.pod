...
C<v-autosavefield> has priority over looking up the property name in the C<v-model> so you can use this to save hierarchical properties, like a JSON object stored in MySQL.
