...
sub format_link {
    ...
    my $response = $ua->get($uri->as_string, Accept => 'text/html;q=0.9,*/*;q=0.8', 'Accept-Encoding' => 'gzip, deflate', 'Accept-Language' => 'en-us', 'User-Agent' => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_5) AppleWebKit/536.28.10 (KHTML, like Gecko) Version/6.0.3 Safari/536.28.10 WingBot', 'Cache-Control' => 'max-age=0');
...
sub format_youtube {
    my $id = shift;
    return q{<div class="embed-responsive embed-responsive-16by9"><iframe class="youtube_video embed-responsive-item" src="https://www.youtube.com/embed/}.$id.q{?rel=0" allowfullscreen></iframe></div>};
}

sub format_vimeo {
    my $id = shift;
    return q{<div class="embed-responsive embed-responsive-16by9"><iframe class="vimeo_video embed-responsive-item" src="https://player.vimeo.com/video/}.$id.q{"></iframe></div>};
}
