...
=============================
 ...
 sudo apt-get install libgnome2-perl build-essential git curl ncurses-dev glib2.0 libexpat1-dev libxml2 libxml2-dev libssl-dev libpng12-dev libjpeg-dev libmysqlclient-dev mysql-server
